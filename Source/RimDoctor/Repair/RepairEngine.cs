...
namespace RimDoctor
{
    ...
    public static class RepairEngine
    {
        ...
        private static string BuildRedirectPatch(List<MissingTextureRef> missing)
        {
            ...
            // generated placeholder). Wrapped in PatchOperationSequence; success
            // requirements are 'Optional' so a missing target never errors.
            ...
            foreach (var m in missing)
            {
                ...
                sb.AppendLine("  <Operation Class=\"PatchOperationReplace\" MayRequire=\"\">");
